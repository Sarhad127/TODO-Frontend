...
const TodoBoard = ({ backgroundColor, backgroundImage, boardData }) => {
    ...
    const handleAddColumn = async () => {
        ...
        try {
            const response = await fetch(`email-verification-production.up.railway.app/auth/boards/${boardId}/columns`, {
                method: 'POST',
                headers: {
        ...
        try {
            await Promise.all(
                columnTasks.map(async (task) => {
                    ...
                    const response = await fetch(`email-verification-production.up.railway.app/tasks/delete/${taskId}`, {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Bearer ${token}`,
            ...
            const columnResponse = await fetch(`email-verification-production.up.railway.app/auth/boards/${board.id}/columns/${columnId}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    const updateColumnPositions = async (updatedColumns) => {                         /* TODO updates column position*/
        try {
            ...
            const response = await fetch('email-verification-production.up.railway.app/columns/update-positions', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    const updateTask = async (taskData) => {                                                   /* TODO updates tasks */
        ...
        try {
            const response = await fetch(`email-verification-production.up.railway.app/tasks/update/${taskData.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
        ...
        if (isTitleChange) {
            ...
            try {
                const response = await fetch(
                    `email-verification-production.up.railway.app/auth/boards/${board.id}/columns/${columnData.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
            ...
            try {
                ...
                const response = await fetch('email-verification-production.up.railway.app/tasks/create', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
    ...
    const deleteTodo = async (todoToDelete) => {                                                /* TODO removes task */
        ...
        try {
            const response = await fetch(`email-verification-production.up.railway.app/tasks/delete/${id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    const addNewColumn = async () => {                                              /* TODO creates new column*/
        if (newColumnTitle.trim()) {
            ...
            try {
                const response = await fetch(`email-verification-production.up.railway.app/auth/boards/${board.id}/columns`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
    ...
    const moveColumn = async (fromIndex, toIndex) => {                  /* TODO reorders columns */
        ...
        try {
            ...
            const response = await fetch(
                `email-verification-production.up.railway.app/auth/boards/${board.id}/columns/order`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
