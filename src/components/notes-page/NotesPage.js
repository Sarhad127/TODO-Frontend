...
const NotesPage = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const response = await fetch('email-verification-production.up.railway.app/api/notes', {
                    headers: {
    ...
    const saveNote = async (index) => {
        try {
            ...
            const response = await fetch(`email-verification-production.up.railway.app/api/notes/${noteToUpdate.id}`, {
                method: 'PUT',
                headers: {
    ...
    const deleteNote = async (index) => {
        try {
            ...
            const response = await fetch(`email-verification-production.up.railway.app/api/notes/${noteToDelete.id}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
