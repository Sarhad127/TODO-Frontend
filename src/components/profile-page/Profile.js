...
const Profile = () => {
    ...
    const handleUsernameUpdate = async () => {
        ...
        try {
            const response = await fetch('email-verification-production.up.railway.app/user/update-username', {
                method: 'PUT',
                headers: {
    ...
    const handlePasswordUpdate = async () => {
        ...
        try {
            const response = await fetch('email-verification-production.up.railway.app/user/change-password', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`,
    ...
    const requestDeletionEmail = async () => {
        ...
        setMessage('');
        try {
            const response = await fetch('email-verification-production.up.railway.app/user/request-account-deletion', {
                method: 'POST',
                headers: {
    ...
    const confirmAccountDeletion = async () => {
        ...
        try {
            const response = await fetch('email-verification-production.up.railway.app/user/confirm-account-deletion', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
